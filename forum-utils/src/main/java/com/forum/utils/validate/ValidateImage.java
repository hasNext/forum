package com.forum.utils.validate;
...
public class ValidateImage {
     ...
     * @return
     */
    public static ValidateImage getInstance() {
     ...
     * @return
     */
    public static ValidateImage getChineseInstance() {
        return new ValidateImage(1);
    }

    private ValidateImage(int location) {
        BufferedImage image = new BufferedImage(WIDTH, HEIGHT,
                BufferedImage.TYPE_INT_RGB);
        initLetterAndNumVerificationCode(image);
    }
    ...
    public void initChinesePlusNumVerificationCode(BufferedImage image) {
        ...
        g.setFont(new Font("宋体", Font.BOLD, 14));// 设定字体
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        ValidateImage instance = ValidateImage.getInstance();
        ...
        System.out.print(instance.getVerificationCodeValue());

        BASE64Encoder encoder = new BASE64Encoder();

        String encode = encoder.encode(baos.toByteArray());

        System.out.print("data:image;base64," + encode);
